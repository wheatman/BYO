...
#define GRAPH_API_DEGREE false
#define GRAPH_API_M false
#define GRAPH_API_PARALLEL_MAP false
#define GRAPH_API_MAP_EARLY_EXIT false
#define GRAPH_API_PARALLEL_MAP_EARLY_EXIT false
#define GRAPH_API_STORE_M false
#define GRAPH_API_STORE_DEGREES false
