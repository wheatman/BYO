...
template<typename F>
inline void aligned_parallel_for(size_t start, size_t end, size_t block_size, F&& f, bool conservative = false) {
  assert(block_size > 0);
  blocked_for(start, end, block_size, [&](size_t block_index, size_t start, size_t end)
  {
